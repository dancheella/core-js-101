...
function getRectangleString(width, height) {
  ...
  const rectangleTop = `┌${horizontalBorder}┐\n`;
  const rectangleMiddle = `│${verticalBorder}│\n`.repeat(height - 2);
  const rectangleBottom = `└${horizontalBorder}┘\n`;

  return rectangleTop + rectangleMiddle + rectangleBottom;
}
